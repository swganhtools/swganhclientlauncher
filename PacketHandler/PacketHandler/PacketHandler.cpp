...
extern int __cdecl Multiply(int nA, int nB)
{
    return nA * nB;
}
extern unsigned int __cdecl GenerateCrc(char* pData,unsigned short nLength,unsigned int nCrcSeed)
{
...
extern bool __cdecl CrcTest(char *pData, unsigned short nLength,unsigned int nCrcSeed, short nCrcLength)
{
    bool crctest = true;
    if(nCrcLength > 0)
    {
...
extern void __cdecl AppendCRC(char *pData, unsigned short nLength, unsigned int nCrcSeed, short nCrcLength)
{
    if (nCrcLength > 0)
    {
...
extern void __cdecl Decrypt(char *pData,unsigned short nLength,unsigned int nCrcSeed)
{
    unsigned int *Data;
    if(pData[0] == 0x00)
    {
...
extern void __cdecl Encrypt(char *pData, unsigned short nLength,unsigned int nCrcSeed)
{
    unsigned int *Data;
    if(pData[0] == 0x00)
    {
...
extern char* __cdecl Decompress(char *pData, unsigned short &nLength)
{
...
extern char* __cdecl Compress(char *pData, unsigned short &nLength)
{
 unsigned short offset;
 if(pData[0] == 0x00)
   offset = 2;
